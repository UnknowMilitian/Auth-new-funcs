    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(null=True, upload_to='user-avatar', verbose_name='Avatar')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user', to='main.user', verbose_name='User')),
            ],
        ),
    ]
